...
namespace VehicleResale.Tests.Base;
...
public abstract class TestBase
{
    ...
    /// </summary>
    protected async Task<Vehicle> SimulatePaymentWebhookAsync(string paymentCode, VehicleResale.Domain.Enums.PaymentStatus status)
    {
        using var scope = _serviceProvider.CreateScope();
        var context = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
